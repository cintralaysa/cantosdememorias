...
export const SERVICES: Service[] = [
  {
    ...
    title: "Plano Básico",
    description: "Uma música personalizada completa para eternizar seu momento especial.",
    price: 39.90,
    priceInCents: 3990,
    image: "/portfolio/fotos/cantor-estudio.png",
    features: ["1 Música personalizada completa", "Letra com o nome do homenageado", "Download MP3 + letra em texto", "Link exclusivo por 30 dias"],
  ...
  },
  {
    ...
    title: "Plano Premium",
    description: "Três músicas personalizadas com temas e estilos diferentes.",
    price: 79.90,
    priceInCents: 7990,
    image: "/portfolio/fotos/cantor-estudio.png",
    features: ["3 Músicas personalizadas", "Letras exclusivas para cada", "Temas diferentes para cada", "Download completo de todos"],
