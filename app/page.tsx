...
export default function Home() {
  ...
  const faqData = [
    ...
    },
    {
      ...
      answer: "A entrega é 100% automática! Após a confirmação do pagamento, sua música é gerada por inteligência artificial em poucos minutos. Você pode ouvir direto no site e também recebe tudo por e-mail para baixar o MP3."
    },
    {
    ...
    },
    {
      ...
      answer: "Sim! A música é 100% sua e você pode usar onde quiser: Instagram, TikTok, YouTube, em festas, eventos, ou qualquer lugar. Você recebe os arquivos em alta qualidade para compartilhar como preferir."
    }
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              <Link
                href="/acesso"
                className={`flex items-center gap-1.5 px-3 py-2 sm:px-4 sm:py-2.5 rounded-full font-semibold text-xs transition-all duration-300 hover:scale-105 ${
                  isScrolled
                    ? 'text-violet-600 hover:bg-violet-50 bg-violet-50/50 sm:bg-transparent'
                    : 'text-white/90 hover:text-white bg-white/10 sm:bg-transparent hover:bg-white/10'
                }`}
              >
                <Music size={14} />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 max-w-5xl mx-auto mb-8 sm:mb-12">
            {[
              ...
              { step: 3, icon: <Music size={22} />, title: 'Receba Automaticamente', desc: 'Ouça direto no site e receba por e-mail — entrega automática em minutos!', color: 'from-amber-500 to-orange-600' }
            ].map((item, index) => (
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-6 text-center">
              <div className="flex items-center gap-2 sm:gap-3">
                ...
                <div className="text-left">
                  <p className="text-white font-bold text-sm sm:text-base">Entrega Automática</p>
                  <p className="text-green-300 text-xs sm:text-sm">Pronta em poucos minutos</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-2 sm:gap-3">
                ...
                <div className="text-left">
                  <p className="text-white font-bold text-sm sm:text-base">Ouça no Site + E-mail</p>
                  <p className="text-purple-300 text-xs sm:text-sm">Acesse e baixe o MP3 na hora</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="text-center sm:text-left sm:grid sm:grid-cols-2 lg:grid-cols-3 gap-8 mb-8">
            ...
            <div className="mb-6 sm:mb-0">
              ...
              <div className="flex items-center justify-center sm:justify-start gap-3 mt-2 sm:mt-4">
                {[
                  ...
                  { icon: <Mail size={18} />, href: 'mailto:contato@cantosdememorias.com.br' },
                ].map((item, i) => (
                  <a
                    key={i}
                    href={item.href}
            ...
            <div className="hidden sm:block">
              ...
              <ul className="space-y-2 text-sm">
                <li>
                  <a href="mailto:contato@cantosdememorias.com.br" className="text-gray-400 hover:text-white">
                    contato@cantosdememorias.com.br
                  </a>
                </li>
                <li>
