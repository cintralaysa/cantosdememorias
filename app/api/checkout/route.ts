  ...
  try {
    ...
    if (service.type === 'voiceover') {
      ...
      Object.assign(metadata, {
        ...
        relationship: sanitizeString(details.relationshipLabel || details.relationship, 50),
        occasion: sanitizeString(details.occasionLabel || details.occasion, 50),
        musicStyle: sanitizeString(details.musicStyleLabel || details.musicStyle, 50),
        ...
        generatedLyrics: sanitizeString(details.generatedLyrics, 500),
